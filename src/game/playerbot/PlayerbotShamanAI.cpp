...
PlayerbotShamanAI::PlayerbotShamanAI(Player* const master, Player* const bot, PlayerbotAI* const ai) : PlayerbotClassAI(master, bot, ai)
{
	...
	// Create stat weights for shaman (no basis behind these, just guesstimates)
...
bool PlayerbotShamanAI::IsNewItemAnUpgrade(Item const *pNewItem, Item const *pCurrentItem)
{
