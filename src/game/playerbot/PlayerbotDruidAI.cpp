...
PlayerbotDruidAI::PlayerbotDruidAI(Player* const master, Player* const bot, PlayerbotAI* const ai) : PlayerbotClassAI(master, bot, ai)
{
	...
	if (spec == DRUID_SPEC_RESTORATION) {
		...
		m_statWeights[ITEM_MOD_SPIRIT] = 0.55f;
	...
	else if (spec == DRUID_SPEC_BALANCE) {
		m_statWeights[ITEM_MOD_STAMINA] = 0.45f;
		m_statWeights[ITEM_MOD_SPIRIT] = 0.25f;
		m_statWeights[ITEM_MOD_INTELLECT] = 0.9f;
		m_statWeights[ITEM_MOD_STRENGTH] = 0.01f;
		m_statWeights[ITEM_MOD_AGILITY] = 0.01f;
	...
	// Catch all for no spec (pre level 10) or no talent points assigned
		...
		m_statWeights[ITEM_MOD_STAMINA] = 0.9f;
		m_statWeights[ITEM_MOD_SPIRIT] = 0.1f;
		m_statWeights[ITEM_MOD_INTELLECT] = 0.5f;
		m_statWeights[ITEM_MOD_STRENGTH] = 0.5f;
...
bool PlayerbotDruidAI::IsNewItemAnUpgrade(Item const *pNewItem, Item const *pCurrentItem)
{
